...
const Topbar = () => {
  ...
  const getmessage: any = useSelector((state: any) => state.topbarmessage);

  // const messageevent = () =>{
  //   return getmessage.successmessage || getmessage.errormessage? setTimeout(function(){  dispatch(messageRemove()) },7000) : "" 
  // }
  // messageevent()

  if(getmessage.successmessage || getmessage.errormessage){
    setTimeout(function () {
  ...
  return (
    <div>
      ...
      {getmessage.successmessage ? (
        <b>
          <p className="success-topbar">{getmessage.successmessage}</p>
        </b>
      ) : getmessage.errormessage ? (
        <b>
          <p className="error-topbar">{getmessage.errormessage}</p>
        </b>
      ) : (
        ""
      )}
