                    ...
                    <div className="col-lg-4" style={{width:'20%'}}>
                      <Link to="accountbalance"  style={{ textDecoration: 'inherit', color:'white'}}  >
                        <div className="d-sm-flex align-items-sm-start justify-content-sm-between">
                            <div className="btn btn-primary text-uppercase">{t('view_account_balance')}</div>
                        </div>
                      </Link>
                    </div>
                    <div className="col-lg-4" style={{width:'20%'}}>
                      <Link to="promotions"  style={{ textDecoration: 'inherit', color:'white'}}>
                        <div className="d-sm-flex align-items-sm-start justify-content-sm-between">
                            <div className="btn btn-primary text-uppercase"> {t('promotion_details')}  </div>
                        </div>
                      </Link>
                    </div>
                    <div className="col-lg-4" style={{width:'20%'}}>
                      <Link to="transactions"  style={{ textDecoration: 'inherit', color:'white'}}>
                        <div className="d-sm-flex align-items-sm-start justify-content-sm-between">
                            <div className="btn btn-primary text-uppercase">{t("show_transaction_history")}</div>
                        </div>
                      </Link>
                    </div>
                </div>
